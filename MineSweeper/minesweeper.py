...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Repeat inference until no new info is found
        inferred = True
        while inferred:
            inferred = False
            ...
            for sentence in self.knowledge:
                safes_to_add |= sentence.known_safes()
                mines_to_add |= sentence.known_mines()

            for cell in safes_to_add:
                if cell not in self.safes:
                    self.mark_safe(cell)
                    inferred = True
            for cell in mines_to_add:
